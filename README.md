...
local Window = OrionLib:MakeWindow({Name = "DragonScript Op", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "DragonScript Op"})

OrionLib:MakeNotification({
	Name = "DragonScript Op",
...
W:AddLabel("[+] DragonScript Op is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "DragonScript Op(Noitification)",
